...
import org.sweble.wikitext.engine.wom.WomVar;
			...
			WomVar
{
	...
	private static final String TAG_AND_NODE_NAME = "var";
	...
	public VarAdapter(AstToWomNodeFactory womNodeFactory, WtXmlElement astNode)
	{
