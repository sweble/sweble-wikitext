			...
			WomSmall
{
	...
	private static final String TAG_AND_NODE_NAME = "small";
	...
	public SmallAdapter(AstToWomNodeFactory womNodeFactory, WtXmlElement astNode)
	{
