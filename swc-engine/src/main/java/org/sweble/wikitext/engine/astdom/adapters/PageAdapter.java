...
import org.sweble.wikitext.engine.astdom.CustomChildrenElement;
            ...
            WomPage
{
	...
	@Override
	protected void replaceChildImpl(DomBackbone newChild, DomBackbone oldChild)
	{
		...
		else
		{
			...
			DomBackbone prevSibling = replacee.getPrevSibling();
			DomBackbone nextSibling = replacee.getNextSibling();
			replacee.unlink();
	...
	public WomRedirect setRedirect(WomRedirect redirect)
	{
		...
		if (redirect != null)
		{
			...
			newRedirect.link(this, null, (DomBackbone) getFirstChild());
