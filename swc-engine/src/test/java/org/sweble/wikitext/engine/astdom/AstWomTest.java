...
import org.sweble.wikitext.engine.astdom.AstWomTestBase.TestCode;
...
public class AstWomTest
{
	...
	public AstWomTest() throws FileNotFoundException, IOException
	{
		...
		//		assertTrue(url != null);
		URL url = new URL("file:/home/dohrn/repos/sweble/sweble-wikitext/swc-engine/target/test-classes/");
