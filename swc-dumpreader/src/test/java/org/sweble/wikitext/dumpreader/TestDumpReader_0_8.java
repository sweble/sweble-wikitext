...
import org.sweble.wikitext.dumpreader.export_0_8.CaseType;
import org.sweble.wikitext.dumpreader.export_0_8.CommentType;
import org.sweble.wikitext.dumpreader.export_0_8.ContributorType;
import org.sweble.wikitext.dumpreader.export_0_8.MediaWikiType;
import org.sweble.wikitext.dumpreader.export_0_8.NamespaceType;
import org.sweble.wikitext.dumpreader.export_0_8.PageType;
import org.sweble.wikitext.dumpreader.export_0_8.RevisionType;
import org.sweble.wikitext.dumpreader.export_0_8.SiteInfoType;
import org.sweble.wikitext.dumpreader.export_0_8.TextType;

import de.fau.cs.osr.utils.StringUtils;

public class TestDumpReader_0_8
{
	...
	{
		URL resource = getClass().getResource("/input-0.8.xml");
			...
			{
				{
					...
					assertEquals("0.8", mw.getVersion());
