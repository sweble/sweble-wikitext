...
public class TestDumpReader_0_5_Fragments
{
	private static final ExportSchemaVersion EXPORT_VERSION = ExportSchemaVersion.V0_5;

	private static final String PAGE_INPUT = "/input-0.5-page.xml";

	private static final String REVISION_INPUT = "/input-0.5-revision.xml";
