...
public class TestDumpReader_0_8_Fragments
{
	private static final ExportSchemaVersion EXPORT_VERSION = ExportSchemaVersion.V0_8;

	private static final String PAGE_INPUT = "/input-0.8-page.xml";

	private static final String REVISION_INPUT = "/input-0.8-revision.xml";
