...
public class ExpandPostprocessPrintAndCompareTest
		extends
			EngineIntegrationTestBase
{
	private static final String FILTER_RX = ".*?\\.wikitext";

	private static final String INPUT_SUB_DIR = "expandPostprocessPrintAndCompare/wikitext";

	private static final String EXPECTED_AST_SUB_DIR = "expandPostprocessPrintAndCompare/ast";
	...
	public ExpandPostprocessPrintAndCompareTest(
			String title,
