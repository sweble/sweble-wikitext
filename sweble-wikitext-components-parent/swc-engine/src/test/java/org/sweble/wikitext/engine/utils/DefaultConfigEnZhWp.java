...
/**
 * Programatically generate a default configuration that is similar to that of
 * the English Wikipedia but additionally configures some basic LCT mappings
 * like in the Chinese Wikipedia.
 */
public class DefaultConfigEnZhWp
		extends
			DefaultConfig
{
	public static WikiConfigImpl generate()
	{
		...
		new DefaultConfigEnZhWp().configureWiki(c);
		return c;
	}
